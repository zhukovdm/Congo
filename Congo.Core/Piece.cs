...
namespace Congo.Core
{
	...
	public static class PieceCodeExtensions
	{
		public static bool IsEmpty(this PieceCode piece) => piece == PieceCode.Empty;
		public static bool IsLion(this PieceCode piece) => piece == PieceCode.Lion;
	}
